...
export default function AboutSection() {
  return (
    <section className="relative w-full max-w-6xl mx-auto px-6 py-20 overflow-visible">
      <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <motion.div
            variants={{
              ...
              visible: { 
                ...
                rotate: 0,
                opacity: 1,
                transition: { type: "spring", damping: 5, stiffness: 40, mass: 1 }
              }
            }}
            whileHover={{ 
              rotate: [-2, 2, -1, 1, 0], 
          ...
          >
            ...
            <div className="w-64 aspect-[3/4.2] bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex flex-col items-center p-2 shadow-2xl relative overflow-hidden group">
              ...
              <div className="w-full h-full bg-black/60 rounded-xl flex flex-col items-center p-4 border border-white/5">
                ...
                <h3 className="text-xl font-bold tracking-tight text-white mt-auto">Dhaval Tanna</h3>
                <p className="text-xs text-blue-400 font-mono text-center mt-1">Software Development Engineer</p>
        ...
        >
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-6">
            I am Dhaval and I am an software development engineer and system security specialist with a deep focus on offensive security, binary exploitation, and building robust backend infrastructure. From designing secure cloud migrations to analyzing kernel-level vulnerabilities, I build systems by understanding exactly how they can be broken.
          </p>
          <Link href="/about" className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 font-medium group">
            Read more about me <ChevronRight size={16} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </motion.div>
