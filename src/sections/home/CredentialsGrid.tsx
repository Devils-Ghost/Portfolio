...
import type { Certification, SoftSkill } from "@/content/types";

/**
 * The two side-by-side modules. Client, because both cards are staggered off
 * a single `useScroll` taken on this section's own element — giving each card
 * its own `whileInView` instead would lose the stagger (PROJECT_PLAN.md §D4).
 * Content arrives as props from the Server Component in CertificationsSection.
 */
